 ...
 * @author DEFRAN-4
 */
@WebServlet(name = "EstoqueGunneboServlet", urlPatterns = {"/EstoqueGunneboServlet"})
public class EstoqueGunneboServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (Session session = sessionFactory.openSession()) {
                ...
                String hql = "FROM EstoqueGunnebo";
                List<EstoqueGunnebo> estoqueGunnebo = session.createQuery(hql, EstoqueGunnebo.class).list();
                ...
                String json = gson.toJson(estoqueGunnebo);
