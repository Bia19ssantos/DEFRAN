 ...
 * @author DEFRAN-4
 */
@WebServlet(name = "ItensServlet", urlPatterns = {"/ItensServlet"})
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (Session session = sessionFactory.openSession()) {
                ...
                List<ItensOrcamentos> itensOrcamentos = session.createQuery(hql, ItensOrcamentos.class).list();
                ...
                String json = gson.toJson(itensOrcamentos);
