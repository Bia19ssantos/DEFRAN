...
import br.com.jcomputacao.defran.model.ManilhasCrosby;
 ...
 * @author DEFRAN-4
 */
@WebServlet(name = "ManilhasCrosbyServlet", urlPatterns = {"/ManilhasCrosbyServlet"})
public class ManilhasCrosbyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (Session session = sessionFactory.openSession()) {
                ...
                String hql = "FROM ManilhasCrosby";
                List<ManilhasCrosby> manilhasCrosby = session.createQuery(hql, ManilhasCrosby.class).list();
                ...
                String json = gson.toJson(manilhasCrosby);
