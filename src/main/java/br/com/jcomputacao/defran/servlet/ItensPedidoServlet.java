 ...
 * @author DEFRAN-4
 */
@WebServlet(name = "ItensPedidoServlet", urlPatterns = {"/ItensPedidoServlet"})
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (Session session = sessionFactory.openSession()) {
                ...
                String hql = "FROM ItensPedido";
                List<ItensPedido> itensPedido = session.createQuery(hql, ItensPedido.class).list();
                ...
                String json = gson.toJson(itensPedido);
