 ...
 * @author DEFRAN-4
 */
@WebServlet(name = "ItensLingasServlet", urlPatterns = {"/ItensLingasServlet"})
public class ItensLingasServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            // Criação de uma nova sessão do Hibernate
                    // Criação de uma nova sessão do Hibernate para Itens do Orçamento
            try (Session session = sessionFactory.openSession()) {
                ...
                String hql = "FROM OrcLingas";
                List<OrcLingas> orcLingas = session.createQuery(hql, OrcLingas.class).list();
                ...
                String json = gson.toJson(orcLingas);
