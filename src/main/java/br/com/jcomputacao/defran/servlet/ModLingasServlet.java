...
import br.com.jcomputacao.defran.model.ModelosLingas;
 ...
 * @author DEFRAN-4
 */
@WebServlet(name = "ModLingasServlet", urlPatterns = {"/ModLingasServlet"})
public class ModLingasServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (Session session = sessionFactory.openSession()) {
                ...
                String hql = "FROM ModelosLingas";
                List<ModelosLingas> modelosLingas = session.createQuery(hql, ModelosLingas.class).list();
                ...
                String json = gson.toJson(modelosLingas);
