 ...
 * @author DEFRAN-4
 */
@WebServlet(name = "BuscaTodosOrcServlet", urlPatterns = {"/BuscaTodosOrcServlet"})
public class BuscaTodosOrcServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (Session session = sessionFactory.openSession()) {
                ...
                String hql = "FROM Orcamento";
                List<Orcamento> orcamento = session.createQuery(hql, Orcamento.class).list();
