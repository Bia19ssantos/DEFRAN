...
@WebServlet(name = "ProdPewagServlet", urlPatterns = {"/ProdPewagServlet"})
public class ProdPewagServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (Session session = sessionFactory.openSession()) {
                ...
                String hql = "FROM ProdutoPewag";
                List<ProdutoPewag> produtosPewag = session.createQuery(hql, ProdutoPewag.class).list();
                ...
                String json = gson.toJson(produtosPewag);
