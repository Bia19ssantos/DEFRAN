...
import br.com.jcomputacao.defran.model.ProdutoCrosby;
 ...
 * @author DEFRAN-4
 */
@WebServlet(name = "ProdutoCrosbyServlet", urlPatterns = {"/ProdutoCrosbyServlet"})
public class ProdutoCrosbyServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (Session session = sessionFactory.openSession()) {
                ...
                String hql = "FROM ProdutoCrosby";
                List<ProdutoCrosby> produtosCrosby = session.createQuery(hql, ProdutoCrosby.class).list();
                ...
                String json = gson.toJson(produtosCrosby);
