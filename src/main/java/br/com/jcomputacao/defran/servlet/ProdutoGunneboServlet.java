 ...
 * @author DEFRAN-4
 */
@WebServlet(name = "ProdutoGunneboServlet", urlPatterns = {"/ProdutoGunneboServlet"})
public class ProdutoGunneboServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try (Session session = sessionFactory.openSession()) {
                ...
                String hql = "FROM ProdutoGunnebo";
                List<ProdutoGunnebo> prodGunnebo = session.createQuery(hql, ProdutoGunnebo.class).list();
                ...
                String json = gson.toJson(prodGunnebo);
